import { useState, useEffect } from 'react';
  import { createIssue, getIssues, updateIssue, deleteIssue } from './services/issueService';
  ...
  const App = () => {
    ...
    const [newIssue, setNewIssue] = useState({ _id: '', title: '', description: '' });
    ...
    const handleCreate = async (event) => {
      ...
      try {
        ...
        setNewIssue({ _id: '', title: '', description: '' });
    ...
    const handleUpdate = async (event) => {
      event.preventDefault();
      try {
        const updatedIssue = await updateIssue(editIssue._id, editIssue);
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            ...
            <div className="mt-4 space-y-4">
              {issues.map(issue => (
                <div key={issue._id} className="p-4 border rounded-lg shadow-sm bg-gray-50 flex justify-between items-center">
                  <div>
